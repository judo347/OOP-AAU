...
/** This class is used to modulate an apartment building containing three apartments per floor (tv, mf, th). */
public class Building3Aparts implements DoorPhone {

    private int numberOfFloors;

    /** The constructor.
     *  @param numberOfFloors numbers of floors in the building. */
    public Building3Aparts(int numberOfFloors) {
        this.numberOfFloors = numberOfFloors;
    }

    /** Use this to call an apartment.
     *  @param apt an apartment call containing the number and postfix (tv, mf, th). */
    @Override
     ...
     *  @param postfix an apartment postfix (tv, mf, th). */
    private boolean isValidPostfix(String postfix){
        if(postfix.equals("tv"))
            return true;
        else if(postfix.equals("mf"))
            return true;
